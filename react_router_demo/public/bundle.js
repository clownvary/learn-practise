...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Repos = __webpack_require__(228);
	...
	var _RoutesStyle = __webpack_require__(230);

	var _RoutesStyle2 = _interopRequireDefault(_RoutesStyle);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.IndexRoute, { components: { header: _Header2.default, footer: _Footer2.default } }),
	        _react2.default.createElement(
	            _reactRouter.Route,
	            { path: 'repos', component: _Repos2.default },
	            _react2.default.createElement(_reactRouter.Route, { path: ':userName/:repoName', component: _Repo2.default })
	        ),
	        _react2.default.createElement(_reactRouter.Route, { path: 'about', component: _About2.default }),
	        _react2.default.createElement(_reactRouter.Route, { onEnter: function onEnter(st, rp) {
	                return (0, _Auth.AuthConfirm)(st, rp);
	            }, path: 'routes_style/:username', component: _RoutesStyle2.default }),
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                _NavLink2.default,
	                                { to: '/routes_style/gary', query: { age: 23 }, hash: '#hhh', state: { sex: 'male' } },
	                                'routes_style'
	                            )
	                        )
	                    )
	                ...
	                this.props.footer,
	                _react2.default.createElement(_About2.default, { name: 'ccccc' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var About = function About(props, context) {
	    var sayHello = function sayHello(str, event) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    'i am params ' + this.props.location.query
	                ),
	                _react2.default.createElement(
	                    'h2',
	                    null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoutesStyle = function (_Component) {
	    _inherits(RoutesStyle, _Component);

	    function RoutesStyle() {
	        _classCallCheck(this, RoutesStyle);

	        return _possibleConstructorReturn(this, (RoutesStyle.__proto__ || Object.getPrototypeOf(RoutesStyle)).apply(this, arguments));
	    }

	    _createClass(RoutesStyle, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var history = this.props.history;

	            _reactRouter.browserHistory.push({ pathname: '/home', state: { score: 70 } });
...
/***/ function(module, exports) {
	...
	function AuthConfirm(nextstate, replace) {
	  var flag = false;
	  var ticket = 'react_route_demo_auth';

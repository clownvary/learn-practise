...
var filterProps = exports.filterProps = function filterProps() {
  ...
  return whitelist.reduce(function (filtered, name) {
    ...
    if (Object.prototype.hasOwnProperty.call(props, name)) {
      ...
      return (0, _extends5.default)({}, filtered, (_extends2 = {}, _extends2[name] = propValue, _extends2));
    } else if (Object.prototype.hasOwnProperty.call(defaults, name)) {
      var _extends3;

      propValue = defaults[name];

      return (0, _extends5.default)({}, filtered, (_extends3 = {}, _extends3[name] = propValue, _extends3));
    }

...
var _templateObject = _taggedTemplateLiteralLoose(['date-picker ', ''], ['date-picker ', '']),
    _templateObject2 = _taggedTemplateLiteralLoose(['date-picker__calendar\n                         ', '\n                         ', '\n                         ', ''], ['date-picker__calendar\n                         ', '\n                         ', '\n                         ', '']),
    _templateObject3 = _taggedTemplateLiteralLoose(['', '\n      ', '\n      ', '\n      ', ''], ['', '\n      ', '\n      ', '\n      ', '']);

import React, { PureComponent, PropTypes } from 'react';
/* eslint import/no-extraneous-dependencies: 0 */
import ReactDOM from 'react-dom';
import 'active.css/less/components/date-picker.less';
...
var propTypes = {
  ...
  getDateStatus: PropTypes.func,
  setDateClass: PropTypes.func,
...
var DatePicker = function (_PureComponent) {
  ...
  function DatePicker(props) {
    ...
    _this.gainFocus = function () {
      ...
      var rect = ReactDOM.findDOMNode(_this.input).getBoundingClientRect();
    ...
    _this.render = function () {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          {
            className: cls(_templateObject2, !isDisplayed ? 'u-hidden' : '', showOnTop ? 'date-picker__calendar--show-on-top' : '', showOnLeft ? 'date-picker__calendar--show-on-left' : ''),
  ...
  DatePicker.prototype.setDateClass = function setDateClass(c, calendarDate, today, dateStatusObj) {
    ...
    return cls(_templateObject3, isOtherMonth(c, calendarDate) ? 'date-picker--other-month' : '', isSameDay(c, today) ? 'date-picker--today' : '', isSameDay(c, this.state.value) ? 'date-picker--selected' : '', setDateClass && setDateClass(dateStatusObj));
  };

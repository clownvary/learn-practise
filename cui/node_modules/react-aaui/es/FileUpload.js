...
var _templateObject = _taggedTemplateLiteralLoose(['file-upload file-upload--', ''], ['file-upload file-upload--', '']);

import React, { PureComponent, PropTypes } from 'react';
import 'active.css/less/components/file-upload.less';
  ...
  FileUpload.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      { ref: function ref(fileUpload) {
        ...
        }, className: cls(_templateObject, this.props.size), style: style },
      React.createElement(
        'div',
        ...
        React.createElement('input', { disabled: true, className: 'file-upload__text input', value: this.state.selectedFile ? this.state.selectedFile.name : this.props.defaultText }),
        React.createElement(
          'span',
      ...
      this.props.ForImage && this.state.selectedFile ? React.createElement(
        ...
        React.createElement('img', { alt: '', width: this.props.thumbnailPercentage + '%', height: this.props.thumbnailPercentage + '%', src: this.state.filePreviewSrc }),

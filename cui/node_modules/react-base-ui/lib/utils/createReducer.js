...
var createHandler = function createHandler(successHandler, errorHandler) {
  return function (state, action) {
    successHandler = successHandler || function (s) {
      return s;
    };
    errorHandler = errorHandler || defaultErrorHandler;
    return !action.error ? successHandler(state, action) : errorHandler(state, action);
  };
};

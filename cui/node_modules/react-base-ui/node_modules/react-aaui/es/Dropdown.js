...
var _templateObject = _taggedTemplateLiteralLoose(['dropdown ', ''], ['dropdown ', '']),
    _templateObject2 = _taggedTemplateLiteralLoose(['dropdown__button ', ' ', ''], ['dropdown__button ', ' ', '']),
    _templateObject3 = _taggedTemplateLiteralLoose(['', ''], ['', '']),
    _templateObject4 = _taggedTemplateLiteralLoose(['dropdown__menu ', ''], ['dropdown__menu ', '']),
    _templateObject5 = _taggedTemplateLiteralLoose([' ', ''], [' ', '']);

import React, { PureComponent, PropTypes } from 'react';
import 'active.css/less/components/dropdown.less';
...
var Dropdown = function (_PureComponent) {
  ...
  function Dropdown(props) {
    ...
    _this.componentWillMount = function () {
      _this.keyboardValue = '';
      _this.clearKeyboardValue = debounce(function () {
        _this.keyboardValue = '';
      }, 600);
    };
    ...
    _this.componentWillReceiveProps = function (nextProps) {
      ...
      if (_Object$keys(newState).length > 0) _this.setState(newState);
    };
    ...
    _this.findItemByValue = function (value) {
      ...
      for (var _iterator = _this.props.data, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
        var _ref;
      ...
      return React.createElement(
        ...
        React.createElement(
          'button',
          {
            ...
            , className: cls(_templateObject2, isMoreButton ? isExpanded ? 'show' : '' : isExpanded ? 'expand' : 'collapse', disabled ? 'disabled' : ''),
          ...
          isMoreButton ? React.createElement('span', { className: 'icon-triangle-down' }) : React.createElement('span', { className: cls(_templateObject3, isExpanded ? 'icon-chevron-up' : 'icon-chevron-down') })
        ),
        React.createElement(
          'div',
          { role: 'combobox' },
          React.createElement(
            'ul',
            {
              className: cls(_templateObject4, isExpanded && !disabled ? 'show' : ''),
              'aria-expanded': cls(_templateObject5, isExpanded && !disabled ? true : undefined),
